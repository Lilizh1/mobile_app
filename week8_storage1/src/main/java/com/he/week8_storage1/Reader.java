...
/**
 * Created by lenovo on 2022/4/18.
 */
...
public class Reader {
    ...
    //下面的构造函数、get和  set函数均可以由 IDE自动生成
    public Reader(String reader_number, String reader_name,
                  String reader_type, String reader_phone,
                  String reader_password, String reader_createtime) {
